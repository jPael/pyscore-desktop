...
class CreateClassFloatingButton extends StatefulWidget {
  const CreateClassFloatingButton({super.key, required this.user});
...
class CreateClassFloatingButtonState extends State<CreateClassFloatingButton> {
  ...
  void handleCreateClassroom() async {
    ...
    Classroom classroom = Classroom(classroomName: name, owner: widget.user);
  ...
  Widget build(BuildContext context) {
    return FloatingActionButton.extended(
      ...
      onPressed: () => showCreateClassroomDialog(context),
